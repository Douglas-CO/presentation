        ...
        <Grid container spacing={8} alignItems="center">
          <Grid item xs={12} md={5}>
            ...
            >
              ...
              extiende hacia el futuro de la inteligencia artificial.
            </Typography>
            <Typography
              variant="body1"
              sx={{
            ...
            >
              Mi objetivo es evolucionar hacia el Prompt Engineering y eventualmente crear mi propia empresa
              tecnológica, combinando innovación técnica con liderazgo empresarial.
            </Typography>
            <Box
              sx={{
                p: 4,
            ...
            >
              ...
              <Typography variant="body2" sx={{ opacity: 0.9 }}>
                "El éxito viene de hacer las preguntas correctas y nunca dejar de aprender"
              </Typography>
            </Box>
          </Grid>
